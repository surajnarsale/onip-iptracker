...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      leaflet
        .tileLayer(
          "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic3VyYWpuYXJzYWxlIiwiYSI6ImNrdTI1dmhmNTE5c3IybnBjcWIxcXdnaWsifQ.t5hD8RXIOdx76xjO2apZ9w",
          {
            attribution:
            ...
            zoomOffset: -1,
            accessToken:
              "pk.eyJ1Ijoic3VyYWpuYXJzYWxlIiwiYSI6ImNrdTI1dmhmNTE5c3IybnBjcWIxcXdnaWsifQ.t5hD8RXIOdx76xjO2apZ9w",
          }
        )
        .addTo(mymap);
    });
    ...
    const getIpInfo = async () => {
      try {
        const data = await axios.get(
          `https://geo.ipify.org/api/v1?apiKey=at_fTwauXXCo4P43klctOAOYPP2QhFMF&ipAddress=${queryIp.value}`
        );
